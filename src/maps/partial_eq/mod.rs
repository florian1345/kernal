...
pub trait MapPartialEqAssertions<'map, M: Map<'map>> {
    ...
    /// [MapEqHashAssertions::contains_values_using_hash](hash::MapEqHashAssertions::contains_values_using_hash)
    /// or
    /// [MapEqOrdAssertions::contains_values_using_ord](btree::MapEqOrdAssertions::contains_values_using_ord)
    ...
    ///
    /// This operation might be slow for large collections. If this is an issue, consider using
    /// [MapEqHashAssertions::contains_exactly_values_using_hash](hash::MapEqHashAssertions::contains_exactly_values_using_hash)
    /// or
    /// [MapEqOrdAssertions::contains_exactly_values_using_ord](btree::MapEqOrdAssertions::contains_exactly_values_using_ord)
    /// instead, if applicable for the item type.
